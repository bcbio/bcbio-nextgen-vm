...
class DockerBuild(base.BaseCommand):
...
class DockerBiodataUpload(base.BaseCommand):
...
class DockerSystemUpdate(base.BaseCommand):
...
class DockerSetupInstall(base.BaseCommand):
...
class DockerDevel(base.BaseCommand):
    ...
    sub_commands = [
        (DockerBuild, "actions"),
        (DockerBiodataUpload, "actions"),
        (DockerSetupInstall, "actions"),
        (DockerSystemUpdate, "actions")
    ]
